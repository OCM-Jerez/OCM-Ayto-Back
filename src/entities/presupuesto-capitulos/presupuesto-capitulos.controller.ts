...
export class PresupuestoCapitulosController {
  constructor(private readonly presupuestoCapitulosService: PresupuestoCapitulosService) {}

  @Post()
  create(@Body() createPresupuestoCapituloDto: CreatePresupuestoCapituloDto) {
    return this.presupuestoCapitulosService.create(createPresupuestoCapituloDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePresupuestoCapituloDto: UpdatePresupuestoCapituloDto) {
    return this.presupuestoCapitulosService.update(+id, updatePresupuestoCapituloDto);
  }
