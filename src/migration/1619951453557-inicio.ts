...
export class inicio1619951453557 implements MigrationInterface {
    name = 'inicio1619951453557'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `economico` (`id` varchar(36) NOT NULL, `createdBy` varchar(255) NULL, `createdDate` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `lastModifiedBy` varchar(255) NULL, `lastModifiedDate` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6), `codPro` varchar(10) NOT NULL, `descripcionAyto` varchar(255) NULL, `descripcionOCM` varchar(255) NOT NULL, `WebOCM` varchar(255) NULL, `Created` varchar(4) NULL, `Deleted` varchar(4) NULL, `uso` varchar(255) NULL, `observaciones` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
